...
import com.example.wallpaperagain.databinding.FragmentAnimalBinding
import com.example.wallpaperagain.databinding.FragmentNatureBinding
...
class NatureFragment : Fragment() {
    ...
    private val queryTags = listOf("Nature") // Tags for animal wallpapers
    ...
    private fun fetchPhotos() {
        lifecycleScope.launch {
            ...
            try {
                ...
                Log.e("AnimalFragment", "Error fetching photos: ${e.message}", e)
            }
        }
    }
